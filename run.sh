...
#python ./src/antifraud.py insight_testsuite/tests/test-1-paymo-trans/paymo_input/batch_payment.txt insight_testsuite/tests/test-1-paymo-trans/paymo_input/stream_payment.txt insight_testsuite/tests/test-1-paymo-trans/paymo_output/output1.txt insight_testsuite/tests/test-1-paymo-trans/paymo_output/output2.txt ./paymo_output/output3.txt
